...
Deno.serve(async (req) => {
  try {
    const { amount, currency, client_name, client_email, departure, arrival, vehicle_type, distance_km, departure_date, departure_time, origin, is_short_notice } = await req.json();
