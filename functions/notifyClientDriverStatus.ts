...
const translations = {
  fr: {
    ...
    on_the_way_body: (name, dep) => `Bonjour <strong style="color:#fff;">${name}</strong>, votre chauffeur Rosini est en chemin et sera bientôt à votre point de départ.`,
    arrived_title: `✅ Votre chauffeur est arrivé !`,
    arrived_body: (name) => `Bonjour <strong style="color:#fff;">${name}</strong>, votre chauffeur Rosini vous attend au point de départ. Bonne route !`,
    departure_label: `POINT DE DÉPART`,
    destination_label: `DESTINATION`,
    contact: `Questions ? Contactez-nous`,
    copyright: (y) => `© ${y} Rosini Transfert. Tous droits réservés.`,
    on_the_way_whatsapp: (name, dep) => `🚗 *Rosini Transfert* — Bonjour ${name}, votre chauffeur est en route vers ${dep}. À tout de suite !`,
    arrived_whatsapp: (name, dep) => `✅ *Rosini Transfert* — Votre chauffeur est arrivé à ${dep} et vous attend. Bonne route !`,
  },
  pt: {
    ...
    on_the_way_body: (name) => `Olá <strong style="color:#fff;">${name}</strong>, o seu motorista Rosini está a caminho e chegará em breve ao seu ponto de partida.`,
    arrived_title: `✅ O seu motorista chegou!`,
    arrived_body: (name) => `Olá <strong style="color:#fff;">${name}</strong>, o seu motorista Rosini está à sua espera no ponto de partida. Boa viagem!`,
    ...
    on_the_way_whatsapp: (name, dep) => `🚗 *Rosini Transfert* — Olá ${name}, o seu motorista está a caminho de ${dep}. Até já!`,
    arrived_whatsapp: (name, dep) => `✅ *Rosini Transfert* — O seu motorista chegou a ${dep} e está à sua espera. Boa viagem!`,
  },
  en: {
    ...
    on_the_way_body: (name) => `Hello <strong style="color:#fff;">${name}</strong>, your Rosini driver is on the way and will arrive at your departure point shortly.`,
    arrived_title: `✅ Your driver has arrived!`,
    arrived_body: (name) => `Hello <strong style="color:#fff;">${name}</strong>, your Rosini driver is waiting for you at the departure point. Have a great trip!`,
    departure_label: `DEPARTURE POINT`,
    destination_label: `DESTINATION`,
    contact: `Questions? Contact us`,
    copyright: (y) => `© ${y} Rosini Transfert. All rights reserved.`,
    on_the_way_whatsapp: (name, dep) => `🚗 *Rosini Transfert* — Hello ${name}, your driver is on the way to ${dep}. See you soon!`,
    arrived_whatsapp: (name, dep) => `✅ *Rosini Transfert* — Your driver has arrived at ${dep} and is waiting for you. Have a great trip!`,
  },
  de: {
    ...
    on_the_way_body: (name) => `Hallo <strong style="color:#fff;">${name}</strong>, Ihr Rosini-Fahrer ist auf dem Weg und wird bald an Ihrem Abholpunkt sein.`,
    arrived_title: `✅ Ihr Fahrer ist angekommen!`,
    arrived_body: (name) => `Hallo <strong style="color:#fff;">${name}</strong>, Ihr Rosini-Fahrer wartet an Ihrem Abholpunkt. Gute Fahrt!`,
    ...
    on_the_way_whatsapp: (name, dep) => `🚗 *Rosini Transfert* — Hallo ${name}, Ihr Fahrer ist auf dem Weg nach ${dep}. Bis gleich!`,
    arrived_whatsapp: (name, dep) => `✅ *Rosini Transfert* — Ihr Fahrer ist in ${dep} angekommen und wartet auf Sie. Gute Fahrt!`,
  },
  it: {
    ...
    on_the_way_body: (name) => `Salve <strong style="color:#fff;">${name}</strong>, il vostro autista Rosini è in arrivo e sarà presto al vostro punto di partenza.`,
    arrived_title: `✅ Il vostro autista è arrivato!`,
    arrived_body: (name) => `Salve <strong style="color:#fff;">${name}</strong>, il vostro autista Rosini vi aspetta al punto di partenza. Buon viaggio!`,
  ...
  es: {
    ...
    on_the_way_body: (name) => `Hola <strong style="color:#fff;">${name}</strong>, su conductor Rosini está en camino y llegará pronto a su punto de salida.`,
    arrived_title: `✅ ¡Su conductor ha llegado!`,
    arrived_body: (name) => `Hola <strong style="color:#fff;">${name}</strong>, su conductor Rosini le espera en el punto de salida. ¡Buen viaje!`,
    departure_label: `PUNTO DE SALIDA`,
    destination_label: `DESTINO`,
    contact: `¿Preguntas? Contáctenos`,
    copyright: (y) => `© ${y} Rosini Transfert. Todos los derechos reservados.`,
    on_the_way_whatsapp: (name, dep) => `🚗 *Rosini Transfert* — Hola ${name}, su conductor está en camino hacia ${dep}. ¡Hasta pronto!`,
    arrived_whatsapp: (name, dep) => `✅ *Rosini Transfert* — Su conductor ha llegado a ${dep} y le está esperando. ¡Buen viaje!`,
  },
  nl: {
    ...
    on_the_way_body: (name) => `Hallo <strong style="color:#fff;">${name}</strong>, uw Rosini-chauffeur is onderweg en zal binnenkort bij uw vertrekpunt zijn.`,
    arrived_title: `✅ Uw chauffeur is gearriveerd!`,
    arrived_body: (name) => `Hallo <strong style="color:#fff;">${name}</strong>, uw Rosini-chauffeur wacht op u bij het vertrekpunt. Goede reis!`,
    ...
    if (client_phone) {
      try {
        ...
        const msgBody = type === 'on_the_way'
          ? t.on_the_way_whatsapp(client_name, departure_point)
          : t.arrived_whatsapp(client_name, departure_point);
