      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="fixed top-6 left-6 z-50">
          <a
            ...
            className="group w-14 h-14 rounded-full bg-black shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(245,195,0,0.5)]"
