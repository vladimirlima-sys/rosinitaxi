...
const texts = {
  fr: {
    ...
    alreadyPaid: 'Cette réservation est déjà payée et ne peut pas être annulée en ligne. Contactez-nous.',
    ...
    successMsg: 'Votre réservation a bien été annulée. Pour tout remboursement, contactez-nous à info@rosini.online.',
  ...
  pt: {
    ...
    alreadyPaid: 'Esta reserva já foi paga e não pode ser cancelada online. Contacte-nos.',
    ...
    successMsg: 'A sua reserva foi cancelada. Para reembolso, contacte-nos em info@rosini.online.',
    contact: 'Contactar',
    errorTitle: 'Erro',
    standard: 'Standard',
    comfort: 'Conforto',
  ...
  en: {
    ...
    alreadyPaid: 'This booking has already been paid and cannot be cancelled online. Please contact us.',
    ...
    successMsg: 'Your booking has been cancelled. For any refund, contact us at info@rosini.online.',
    contact: 'Contact us',
    errorTitle: 'Error',
    standard: 'Standard',
    comfort: 'Comfort',
  ...
  de: {
    ...
    alreadyPaid: 'Diese Buchung wurde bereits bezahlt und kann nicht online storniert werden. Kontaktieren Sie uns.',
    ...
    successMsg: 'Ihre Buchung wurde storniert. Für Rückerstattungen kontaktieren Sie uns unter info@rosini.online.',
    contact: 'Kontakt',
    errorTitle: 'Fehler',
    standard: 'Standard',
    comfort: 'Komfort',
  ...
  it: {
    ...
    alreadyPaid: 'Questa prenotazione è già stata pagata e non può essere cancellata online. Contattateci.',
    ...
    successMsg: 'La tua prenotazione è stata cancellata. Per i rimborsi, contattateci a info@rosini.online.',
    contact: 'Contattaci',
    errorTitle: 'Errore',
    standard: 'Standard',
    comfort: 'Comfort',
