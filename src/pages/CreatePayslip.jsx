...
export default function CreatePayslip() {
  ...
  const buildPayslip = () => ({
    ...
    avs_percentage: parseFloat(tx.avs_percentage) || 0,
    avs_amount,
    ai_percentage: parseFloat(tx.ai_percentage) || 0,
    ai_amount,
    apg_percentage: parseFloat(tx.apg_percentage) || 0,
    apg_amount,
    ac_percentage: parseFloat(tx.ac_percentage) || 0,
    ac_amount,
    af_percentage: parseFloat(tx.af_percentage) || 0,
    af_amount,
    pc_percentage: parseFloat(tx.pc_percentage) || 0,
    pc_amount,
