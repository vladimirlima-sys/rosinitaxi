  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <p className="text-lg md:text-2xl font-extralight text-[#C9A96E] tracking-[0.3em] uppercase mb-5">
          Transports et locations Sarl
        </p>
        
        <div className="w-16 h-[1px] bg-[#C9A96E] mx-auto mb-5" />
        
        <p className="text-base md:text-lg text-white/60 font-light max-w-2xl mx-auto mb-8 leading-relaxed">
          {t.heroDesc}
        </p>
        ...
        <button
          ...
          className="group inline-flex items-center gap-3 bg-[#C9A96E] hover:bg-[#B8955D] text-[#0A0A0A] font-semibold px-8 py-3 rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-[#C9A96E]/20"
        >
          {t.cta}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
        <div className="w-[1px] h-8 bg-gradient-to-b from-transparent to-[#C9A96E]/50" />
