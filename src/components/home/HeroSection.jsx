    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-white/50 font-light max-w-2xl mx-auto mb-12 leading-relaxed">
          Service de transfert privé premium pour vos trajets longue distance en Suisse et en Europe. 
          Confort, ponctualité et élégance.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-16">
          {[
            ...
            { icon: Shield, label: 'Chauffeurs professionnels' },
            { icon: MapPin, label: 'Longue distance' },
          ].map((item, i) => (
