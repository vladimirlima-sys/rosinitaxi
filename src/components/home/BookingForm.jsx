...
export default function BookingForm({ bookingRef }) {
  ...
  }, []);const handleRouteCalculated = (routeData) => {if (routeData.distance_km > 0) {setEstimatedDistance(routeData.distance_km);setEstimatedTime(routeData.estimated_time_minutes);update('distance_km', routeData.distance_km);}};const getPricePerKm = () => {if (!priceSettings) return 0;if (form.vehicle_type === 'comfort') return priceSettings.comfort_price_per_km || priceSettings.standard_price_per_km * 1.3;
