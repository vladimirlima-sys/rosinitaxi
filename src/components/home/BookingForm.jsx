        ...
        {step === 2 && (
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <button onClick={() => setStep(1)} className="flex-1 h-12 rounded-xl border-2 border-[#F5C300] bg-[#F5C300] text-black font-semibold text-sm hover:bg-[#e6b800] transition-all">{t.backBtn}</button>
              <button
                onClick={() => setStep(3)}
        ...
        {step === 3 && (
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setStep(2)}
                className="flex-1 h-12 rounded-xl border-2 border-black bg-white text-black font-semibold text-sm hover:bg-black/10 transition-all"
              >
                {t.backBtn}
              </button>
              <button
                ...
                className={`flex-[2] h-12 rounded-xl font-bold text-sm uppercase tracking-wider transition-all ${
                  canProceedStep3
                    ? 'bg-[#F5C300] text-black hover:bg-[#e6b800]'
                    : 'bg-white/10 text-white/40 cursor-not-allowed'
                }`}
              >
                {t.paymentBtn}
        ...
        {step === 4 && (
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setStep(3)}
                className="flex-1 h-12 rounded-xl border-2 border-[#F5C300] bg-[#F5C300] text-black font-semibold text-sm hover:bg-[#e6b800] transition-all"
              >
                {t.backBtn}
              </button>
              <button
                ...
                className="flex-[2] h-12 rounded-xl bg-[#F5C300] text-black font-bold text-sm uppercase tracking-wider hover:bg-[#e6b800] transition-all disabled:opacity-60 flex items-center justify-center gap-2"
              >
