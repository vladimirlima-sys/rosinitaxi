        ...
        {step === 2 && (
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <button onClick={() => setStep(1)} className="flex-1 h-12 rounded-xl border-2 border-black bg-white text-black font-semibold text-sm hover:bg-black/10 transition-all">{t.backBtn}</button>
              <button
                onClick={() => setStep(3)}
