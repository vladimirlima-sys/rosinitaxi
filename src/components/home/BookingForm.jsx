        ...
        {step === 2 && (
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Citro%C3%ABn_C4_II_%28facelift%2C_red%29%2C_front_8.29.19.jpg/320px-Citro%C3%ABn_C4_II_%28facelift%2C_red%29%2C_front_8.29.19.jpg" alt="Citroën C4" className="w-16 h-10 object-cover rounded-lg" />
                  <div>
            ...
            <div className="flex gap-3">
              <button onClick={() => setStep(1)} className="flex-1 h-12 rounded-xl border border-white/20 text-white/60 font-semibold text-sm hover:bg-white/10 transition-all">{t.backBtn}</button>
              <button
                onClick={() => setStep(3)}
